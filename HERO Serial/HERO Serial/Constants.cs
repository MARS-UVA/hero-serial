...
public static class Constants
{
    ...
    public enum CANID : int
    {
        ...
        BUCKETLADDER_LIFTER0_TALON_ID = 96,
        BUCKETLADDER_LIFTER1_TALON_ID = 95,
        BUCKETLADDER_EXTENDER_TALON_ID = 97,
        BUCKETLADDER_CHAIN_DRIVER_TALON_ID = 98,
        DEPOSITSYSTEM_BASKET_LIFTER0_TALON_ID = 99,
        DEPOSITSYSTEM_BASKET_LIFTER1_TALON_ID = 94,
        CONVEYOR_DRIVER_TALON_ID = 93,
        PDP_ID = 62
    }
    ...
    public class CANIterator : System.Collections.IEnumerator
    {
        ...
        private static CANID[] CANIDArray = {
            ...
            CANID.CONVEYOR_DRIVER_TALON_ID
        };
