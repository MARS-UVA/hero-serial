...
public static class Constants
{
    ...
    public enum CANID : int
    {
        ...
        DRIVETRAIN_FRONT_RIGHT_TALON_ID = 6,
        DRIVETRAIN_BACK_LEFT_TALON_ID = 5,
        DRIVETRAIN_BACK_RIGHT_TALON_ID = 7,
        BUCKETLADDER_LIFTER_TALON_ID = 8,
        BUCKETLADDER_EXTENDER_TALON_ID = 9,
        BUCKETLADDER_CHAIN_DRIVER_TALON_ID = 10,
        DEPOSITSYSTEM_BASKET_LIFTER_TALON_ID = 11
    }
